...
- **ID:** reviewer
- **Nome:** Raul Revisão
- **Título:** Revisor de Qualidade — Modo Econômico
...
- **Reads from:** copy final (step-04), slides renderizados (step-06), `data/quality-criteria.md`, `data/linkedin-strategy.md`
