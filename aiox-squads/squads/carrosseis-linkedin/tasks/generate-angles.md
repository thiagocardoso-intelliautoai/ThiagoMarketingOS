...
- `data/theme-input.md` — Tema e estilo escolhidos pelo usuário
- `data/linkedin-strategy.md` — Estratégia completa do Thiago
- `data/tone-of-voice.md` — Opções de tom de voz
- `data/domain-framework.md` — Metodologia operacional
- `agents/copywriter.md` — Persona do Caio Carrossel
