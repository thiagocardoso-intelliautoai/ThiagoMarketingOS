# Anti-AI Design Rules — Global (Todos os Squads)

> **Contexto:** Feedback real do Thiago: "Bato o olho e falo 'feito por IA'."
> Este documento é OBRIGATÓRIO para TODO conteúdo visual gerado por QUALQUER squad.
> Ler ANTES de criar qualquer HTML, capa, slide ou carrossel.

> **Escopo:** Aplica-se a todos os squads:
> - `carrosseis-linkedin` (4 estilos visuais)
> - `capas-linkedin` (5 estilos visuais)
> - Qualquer novo squad visual futuro
...
- **Proibido:** Mais de 2 elementos decorativos na mesma capa/slide (ícone + glow + barra lateral + connector + box = 5 elementos).
...
- **Regra:** Máximo 2 elementos decorativos por peça visual. Um primário (ex: regra horizontal) e um secundário (ex: aspas grandes). Whitespace preenche o resto.
...
- **Alternativa:** Usar paleta do Design System global (`design-system.md`). Amber/gold para urgência (em vez de vermelho). Slate/charcoal para seriedade (em vez de preto puro).
...
### 7. Uma Cor de Acento por Peça, Máximo
- Paleta: fundo + texto + UMA cor de acento (do Design System global)
- A cor de acento destaca A INFORMAÇÃO MAIS IMPORTANTE, não "enfeita"
- Não usar gradiente na cor de acento — cor flat sólida
- Consultar `design-system.md` para paleta permitida

---

## Checklist Obrigatório Pré-Entrega

Antes de renderizar QUALQUER peça visual (capa OU slide de carrossel), verificar:
...
- [ ] Cores usadas estão no Design System global
...
> Mostre a peça visual para alguém e pergunte: "Isso foi feito por uma pessoa ou por IA?"
