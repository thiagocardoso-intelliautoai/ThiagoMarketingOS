...
1. Siga a Constitution em `aiox-project/.aiox-core/constitution.md`
2. Priorize `CLI First -> Observability Second -> UI Third`
3. Trabalhe por stories em `aiox-project/docs/stories/`
...
- Core framework: `aiox-project/.aiox-core/`
- CLI entrypoints: `bin/`
...
- Canonico: `aiox-project/.aiox-core/development/agents/*.md`
...
2. Se necessario, use fonte canonica em `aiox-project/.aiox-core/development/agents/`

Ao ativar agente:
- carregar definicao completa do agente
- renderizar greeting via `node aiox-project/.aiox-core/development/scripts/generate-greeting.js <agent-id>`
