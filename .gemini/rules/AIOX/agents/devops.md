...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node aiox-project/.aiox-core/development/scripts/unified-activation-pipeline.js devops
...
dependencies:
  ...
  repository_agnostic_design:
    ...
    installation_modes:
      framework-development: 'aiox-project/.aiox-core/ is SOURCE CODE (committed to git)'
      project-development: 'aiox-project/.aiox-core/ is DEPENDENCY (gitignored, in node_modules)'
    detection_priority:
...
---
---
*AIOX Agent - Synced from aiox-project/.aiox-core/development/agents/devops.md*
