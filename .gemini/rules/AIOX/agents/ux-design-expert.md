...
IDE-FILE-RESOLUTION:
  ...
  - Dependencies map to aiox-project/.aiox-core/development/{type}/{name}
  - type=folder (tasks|templates|checklists|data|workflows|etc...), name=file-name
  - Example: audit-codebase.md → aiox-project/.aiox-core/development/tasks/audit-codebase.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      2. Show: "**Role:** {persona.role}"
         - Append: "Story: {active story from aiox-project/docs/stories/}" if detected + "Branch: `{branch from gitStatus}`" if not main/master
      3. Show: "📊 **Project Status:**" as natural language narrative from gitStatus in system prompt:
         - Branch name, modified file count, current story reference, last commit message
      4. Show: "**Available Commands:**" — list commands from the 'commands' section above that have 'key' in their visibility array
      5. Show: "Type `*guide` for comprehensive usage instructions."
      5.5. Check `aiox-project/.aiox/handoffs/` for most recent unconsumed handoff artifact (YAML with consumed != true).
           If found: read `from_agent` and `last_command` from artifact, look up position in `aiox-project/.aiox-core/data/workflow-chains.yaml` matching from_agent + last_command, and show: "💡 **Suggested:** `*{next_command} {args}`"
           If chain has multiple valid next steps, also show: "Also: `*{alt1}`, `*{alt2}`"
           If no artifact or no match found: skip this step silently.
           After STEP 4 displays successfully, mark artifact as consumed: true.
      6. Show: "{persona_profile.communication.signature_closing}"
      # FALLBACK: If native greeting fails, run: node aiox-project/.aiox-core/development/scripts/unified-activation-pipeline.js ux-design-expert
...
agent:
  ...
  customization: |
    ...
    Phase 1 Commands:
    *research        → Read("aiox-project/.aiox-core/development/tasks/ux-user-research.md")
    *wireframe       → Read("aiox-project/.aiox-core/development/tasks/ux-create-wireframe.md")
    *generate-ui-prompt → Read("aiox-project/.aiox-core/development/tasks/generate-ai-frontend-prompt.md")
    *create-front-end-spec → Read("aiox-project/.aiox-core/development/tasks/create-doc.md") + template

    Phase 2 Commands:
    *audit           → Read("aiox-project/.aiox-core/development/tasks/audit-codebase.md")
    *consolidate     → Read("aiox-project/.aiox-core/development/tasks/consolidate-patterns.md")
    *shock-report    → Read("aiox-project/.aiox-core/development/tasks/generate-shock-report.md")

    Phase 3 Commands:
    *tokenize        → Read("aiox-project/.aiox-core/development/tasks/extract-tokens.md")
    *setup           → Read("aiox-project/.aiox-core/development/tasks/setup-design-system.md")
    *migrate         → Read("aiox-project/.aiox-core/development/tasks/generate-migration-strategy.md")
    *upgrade-tailwind → Read("aiox-project/.aiox-core/development/tasks/tailwind-upgrade.md")
    *audit-tailwind-config → Read("aiox-project/.aiox-core/development/tasks/audit-tailwind-config.md")
    *export-dtcg     → Read("aiox-project/.aiox-core/development/tasks/export-design-tokens-dtcg.md")
    *bootstrap-shadcn → Read("aiox-project/.aiox-core/development/tasks/bootstrap-shadcn-library.md")

    Phase 4 Commands:
    *build           → Read("aiox-project/.aiox-core/development/tasks/build-component.md")
    *compose         → Read("aiox-project/.aiox-core/development/tasks/compose-molecule.md")
    *extend          → Read("aiox-project/.aiox-core/development/tasks/extend-pattern.md")

    Phase 5 Commands:
    *document        → Read("aiox-project/.aiox-core/development/tasks/generate-documentation.md")
    *a11y-check      → Read("aiox-project/.aiox-core/development/checklists/accessibility-wcag-checklist.md")
    *calculate-roi   → Read("aiox-project/.aiox-core/development/tasks/calculate-roi.md")

    Universal Commands:
    *scan            → Read("aiox-project/.aiox-core/development/tasks/ux-ds-scan-artifact.md")
    *integrate       → Read("aiox-project/.aiox-core/development/tasks/integrate-Squad.md")
...
---
---
*AIOX Agent - Synced from aiox-project/.aiox-core/development/agents/ux-design-expert.md*
