...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node aiox-project/.aiox-core/development/scripts/unified-activation-pipeline.js po
...
commands:
  ...
  - name: stories-index
    visibility: [full, quick]
    description: 'Regenerate story index from aiox-project/docs/stories/'
...
3. Story templates available in `aiox-project/.aiox-core/product/templates/`
...
---
---
*AIOX Agent - Synced from aiox-project/.aiox-core/development/agents/po.md*
