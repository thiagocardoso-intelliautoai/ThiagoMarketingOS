...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node aiox-project/.aiox-core/development/scripts/unified-activation-pipeline.js aiox-master
  ...
  - CRITICAL: NEVER LOAD aiox-project/.aiox-core/data/aiox-kb.md UNLESS USER TYPES *kb
...
2. Templates available in `aiox-project/.aiox-core/product/templates/`
...
---
---
*AIOX Agent - Synced from aiox-project/.aiox-core/development/agents/aiox-master.md*
