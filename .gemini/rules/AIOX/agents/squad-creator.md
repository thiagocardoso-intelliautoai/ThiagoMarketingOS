...
IDE-FILE-RESOLUTION:
  ...
  - Example: squad-creator-create.md → aiox-project/.aiox-core/development/tasks/squad-creator-create.md
...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node aiox-project/.aiox-core/development/scripts/unified-activation-pipeline.js squad-creator
  ...
  - EXCEPTION: STEP 5.5 may read `aiox-project/.aiox/handoffs/` and `aiox-project/.aiox-core/data/workflow-chains.yaml` during activation
...
1. AIOX project initialized (`aiox-project/.aiox-core/` exists)
...
---
---
*AIOX Agent - Synced from aiox-project/.aiox-core/development/agents/squad-creator.md*
