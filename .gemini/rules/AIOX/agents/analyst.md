...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node aiox-project/.aiox-core/development/scripts/unified-activation-pipeline.js analyst
...
---
---
*AIOX Agent - Synced from aiox-project/.aiox-core/development/agents/analyst.md*
