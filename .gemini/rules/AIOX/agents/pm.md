...
IDE-FILE-RESOLUTION:
  ...
  - Example: create-doc.md → aiox-project/.aiox-core/development/tasks/create-doc.md
...
activation-instructions:
  ...
  - STEP 2.5: |
      ...
      Check user_profile using config-resolver's resolveConfig():
        ...
        - If user_profile === 'bob':
          → Load bob-orchestrator.js module from aiox-project/.aiox-core/core/orchestration/bob-orchestrator.js
      ...
      Module: aiox-project/.aiox-core/core/config/config-resolver.js
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node aiox-project/.aiox-core/development/scripts/unified-activation-pipeline.js pm
  - STEP 3.5: |
      ...
      1. Run data lifecycle cleanup first:
         - const { runStartupCleanup } = require('aiox-project/.aiox-core/core/orchestration/data-lifecycle-manager')
         - await runStartupCleanup(projectRoot) // Cleanup locks, sessions >30d, snapshots >90d

      2. Check for existing session state:
         - const { BobOrchestrator } = require('aiox-project/.aiox-core/core/orchestration/bob-orchestrator')
      ...
      Module: aiox-project/.aiox-core/core/orchestration/bob-orchestrator.js (Story 12.5)
      Module: aiox-project/.aiox-core/core/orchestration/data-lifecycle-manager.js (Story 12.5)
      Task: aiox-project/.aiox-core/development/tasks/session-resume.md
...
persona:
  ...
  orchestration_constraints:
    ...
    integration:
      module: aiox-project/.aiox-core/core/orchestration/terminal-spawner.js
      script: aiox-project/.aiox-core/scripts/pm.sh
      executor_assignment: aiox-project/.aiox-core/core/orchestration/executor-assignment.js
...
2. PRD templates in `aiox-project/.aiox-core/product/templates/`
...
---
---
*AIOX Agent - Synced from aiox-project/.aiox-core/development/agents/pm.md*
