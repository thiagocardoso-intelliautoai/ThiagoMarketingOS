...
activation-instructions:
  ...
  - STEP 3: |
      ...
      # FALLBACK: If native greeting fails, run: node aiox-project/.aiox-core/development/scripts/unified-activation-pipeline.js dev
  ...
  - STAY IN CHARACTER!
  - CRITICAL: Read the following full files as these are your explicit rules for development standards for this project - aiox-project/.aiox-core/core-config.yaml devLoadAlwaysFiles list
...
dependencies:
  ...
  decision_logging:
    ...
    utility: 'aiox-project/.aiox-core/utils/decision-log-generator.js'
    ...
    usage_example: |
      ...
      const { generateDecisionLog } = require('aiox-project/.aiox-core/utils/decision-log-generator');

      const context = {
        agentId: 'dev',
        storyPath: 'aiox-project/docs/stories/story-X.X.X.md',
        startTime: Date.now(),
        decisions: [],
        filesModified: [],
        testsRun: [],
...
1. Story file must exist in `aiox-project/docs/stories/`
...
---
---
*AIOX Agent - Synced from aiox-project/.aiox-core/development/agents/dev.md*
