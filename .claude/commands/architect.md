---
description: Ativa o agente Architect (Aria) — arquitetura e design técnico
---

# Ativação do Agente Architect (Aria)

**INSTRUÇÕES PARA O CLAUDE CODE:**

1. Leia COMPLETAMENTE o arquivo `aiox-project/.antigravity/agents/architect.md`
