---
description: Ativa o agente Analyst (Alex) — pesquisa e análise
---

# Ativação do Agente Analyst (Alex)

**INSTRUÇÕES PARA O CLAUDE CODE:**

1. Leia COMPLETAMENTE o arquivo `aiox-project/.antigravity/agents/analyst.md`
