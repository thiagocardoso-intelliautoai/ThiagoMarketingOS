---
description: Ativa o agente PO (Pax) — Product Owner, validação de stories e épicos
---

# Ativação do Agente PO (Pax)

**INSTRUÇÕES PARA O CLAUDE CODE:**

1. Leia COMPLETAMENTE o arquivo `aiox-project/.antigravity/agents/po.md`
