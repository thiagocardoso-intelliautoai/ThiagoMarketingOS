---
description: Ativa o agente UX Design Expert (Uma) — UX/UI design, frontend spec
---

# Ativação do Agente UX Design Expert (Uma)

**INSTRUÇÕES PARA O CLAUDE CODE:**

1. Leia COMPLETAMENTE o arquivo `aiox-project/.antigravity/agents/ux-design-expert.md`
