---
description: Ativa o agente SM (River) — Scrum Master, criação de stories
---

# Ativação do Agente SM (River)

**INSTRUÇÕES PARA O CLAUDE CODE:**

1. Leia COMPLETAMENTE o arquivo `aiox-project/.antigravity/agents/sm.md`
