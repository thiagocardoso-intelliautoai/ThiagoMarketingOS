---
description: Ativa o agente Data Engineer (Dara) — database design, Supabase, migrations
---

# Ativação do Agente Data Engineer (Dara)

**INSTRUÇÕES PARA O CLAUDE CODE:**

1. Leia COMPLETAMENTE o arquivo `aiox-project/.antigravity/agents/data-engineer.md`
...
7. Siga as regras globais em `aiox-project/.claude/rules/agent-authority.md`
