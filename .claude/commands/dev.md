---
description: Ativa o agente Dev (Dex) — implementação de código
---

# Ativação do Agente Dev (Dex)

**INSTRUÇÕES PARA O CLAUDE CODE:**

1. Leia COMPLETAMENTE o arquivo `aiox-project/.antigravity/agents/dev.md`
